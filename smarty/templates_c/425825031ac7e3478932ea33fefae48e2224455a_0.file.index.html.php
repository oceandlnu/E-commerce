<?php
/* Smarty version 3.1.30, created on 2018-01-03 21:29:17
  from "/var/www/html/E-commerce/smarty/templates/user/index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a4cdaadd62ce9_57898313',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '425825031ac7e3478932ea33fefae48e2224455a' => 
    array (
      0 => '/var/www/html/E-commerce/smarty/templates/user/index.html',
      1 => 1514986156,
      2 => 'file',
    ),
  ),
...
function content_5a4cdaadd62ce9_57898313 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['cates']->value, 'cate');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['cate']->value) {
?>
<div class="shopTit comWidth">
    <span class="icon"></span>
    <h3><?php echo $_smarty_tpl->tpl_vars['cate']->value['cName'];?>
</h3>
...
<div class="shopList comWidth clearfix">
    ...
    <div class="rightArea">
        <div class="shopList_top clearfix">
            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, getProBycId($_smarty_tpl->tpl_vars['cate']->value['id']), 'pro');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['pro']->value) {
?>
            <?php $_smarty_tpl->_assignInScope('proImg', getProImgById($_smarty_tpl->tpl_vars['pro']->value['id']));
?>
            <div class="shop_item">
                <div class="shop_img">
                    <a href="proDetails.php?id=<?php echo $_smarty_tpl->tpl_vars['pro']->value['id'];?>
" target="_blank"><img width="187" height="200" src="images/uploads/<?php echo $_smarty_tpl->tpl_vars['proImg']->value['albumPath'];?>
" alt=""></a>
                </div>
                <h4><?php echo $_smarty_tpl->tpl_vars['pro']->value['pName'];?>
</h4>
                <p><?php echo $_smarty_tpl->tpl_vars['pro']->value['iPrice'];?>
元</p>
            </div>
            <?php
}
...
?>
        ...
        <div class="shopList_sm clearfix">
            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, getSmallProBycId($_smarty_tpl->tpl_vars['cate']->value['id']), 'proSmall');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['proSmall']->value) {
?>
            <?php $_smarty_tpl->_assignInScope('proSmallImg', getProImgById($_smarty_tpl->tpl_vars['proSmall']->value['id']));
?>
            <div class="shopItem_sm">
                <div class="shopItem_smImg">
                    <a href="proDetails.php?id=<?php echo $_smarty_tpl->tpl_vars['proSmall']->value['id'];?>
" target="_blank"><img width="95" height="95" src="images/uploads/<?php echo $_smarty_tpl->tpl_vars['proSmallImg']->value['albumPath'];?>
" alt=""></a>
                </div>
                <div class="shopItem_text">
                    <h4><?php echo $_smarty_tpl->tpl_vars['proSmall']->value['pName'];?>
</h4>
                    <p><?php echo $_smarty_tpl->tpl_vars['proSmall']->value['iPrice'];?>
元</p>
                </div>
            </div>
            <?php
